...
{ak nieje ulozeny}
  Case
  MessageDlg('S˙bor bol zmenen˝, chcete ho uloûiù?',
    mtConfirmation, [mbYes, mbNo, mbCancel], 0) of
...
begin
  ...
  writeln(sub, '<h6>');
  writeln(sub, 'Generated by '+menoprogramu+' software, Michal ätefanËÌk 2007-2011');
  writeln(sub, '</h6>');
  writeln(sub, '</body>');
  writeln(sub, '</html>');
  closefile(sub);
...
begin
  ...
  writeln(sub, '<h5> Created by '+menoprogramu+' software, Michal ätefanËÌk 2007-2011</h5>');
  writeln(sub, '</div>');
end;
