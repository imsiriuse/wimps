...
begin
    ...
    for I:=1 to pozorovanie.RojPocet do
      ...
      if (strtoint(pozorovanie.ZaciatokH)+strtoint(pozorovanie.ZaciatokM)/60)=
        ...
        then
          begin
            chyba:=true;
            error('Observation begin', 'Rovnaké èasy', '7');
          end;
  ...
  if timecheck(strtoint(pozorovanie.intervaly[I-1].ZacH)+strtoint(pozorovanie.intervaly[I-1].ZacM)/60,
    ...
    then
      begin
        chyba:=true;
        error('Interval ['+inttostr(I)+']','Intervaly sa prekrývajú', '10');
      end;
      ...
      begin
        ...
        if TimeVyskaCheck(
          ...
          then
            begin
              chyba:=true;
              error('Intervaly['+inttostr(I)+'], Pozorovate¾ ['+inttostr(J)+'] Lim. magnitúdy ['+inttostr(K)+']','Limitny trojuholnik pod obzorom', '13');
            end;
      end;
    *)
	  for I:=1 to pozorovanie.IntPocet do
